...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      &kp PG_UP,         &kp INS,           &kp HOME,          &kp UP,            &kp END,           &kp RIGHT,         \
&kp LCTRL,         &kp LALT,          &kp LGUI,          &kp LSHFT,         &kp PG_DN,         &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp RIGHT,         U_NP,              \
